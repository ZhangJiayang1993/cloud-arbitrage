package com.arbitrage.common.redis;
...
//    private static final JdkSerializationRedisSerializer OBJECT_SERIALIZER = new JdkSerializationRedisSerializer();
     ...
     * value 序列化
     */
    private static final GenericJackson2JsonRedisSerializer OBJECT_SERIALIZER;
    ...
    static {
        ...
        timeModule.addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern(STANDARD_PATTERN)));
        timeModule.addSerializer(LocalDate.class, new LocalDateSerializer(DateTimeFormatter.ofPattern(DATE_PATTERN)));
        timeModule.addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(DateTimeFormatter.ofPattern(STANDARD_PATTERN)));
        objectMapper.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
        objectMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
        objectMapper.registerModule(timeModule);
        OBJECT_SERIALIZER = new GenericJackson2JsonRedisSerializer(objectMapper);
    }
    ...
    public RedisRepository(RedisTemplate<String, Object> redisTemplate) {
        ...
        this.redisTemplate.setHashValueSerializer(STRING_SERIALIZER);
    }
    ...
    public Object get(final String key) {
        Object resultStr = redisTemplate.execute((RedisCallback<Object>) connection -> {
            ...
            Object result = null;
            try {
                result = OBJECT_SERIALIZER.deserialize(values);
